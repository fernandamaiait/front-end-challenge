      ...
      },
      {
        ...
        release_dates: [
          ...
          },
          {
            ...
            descriptors: [],
            iso_639_1: 'en',
            note: '20th Century Fox Home Entertainment #2000306 [VHS] 139 minutes',
            release_date: '2000-04-25T00:00:00.000Z',
            type: 5
          }
        ]
      },
  ...
  credits: {
    cast: [
      ...
      },
      {
        ...
        popularity: 41.016,
        profile_path: '/1k9MVNS9M3Y4KejBHusNdbGJwRw.jpg',
        cast_id: 5,
    ...
    results: [
      {
        ...
        backdrop_path: null,
        id: 1099066,
        title: 'Hitlers letzte Tage - Der Film "Der Untergang"',
        original_language: 'de',
        original_title: 'Hitlers letzte Tage - Der Film "Der Untergang"',
        overview: "Documentary about the 2004 movie 'Der Untergang' aka. 'Downfall'",
        poster_path: null,
        media_type: 'movie',
        genre_ids: [99],
        popularity: 0.841,
      ...
      },
      {
        ...
        poster_path: '/k3UoZhRHg6h2XYzwNAJJvGC2yev.jpg',
        media_type: 'movie',
        genre_ids: [28, 878, 12],
        popularity: 93.437,
      ...
      },
      {
        ...
        poster_path: '/xFOZFOdQFijudZrgX53mHeBI2Ff.jpg',
        media_type: 'movie',
        genre_ids: [18, 37],
        popularity: 76.327,
      ...
      },
      {
        ...
        poster_path: '/7leBWM27Q0TUnvmhw6WnFNgGn4G.jpg',
        media_type: 'movie',
        genre_ids: [9648, 53],
        popularity: 37.513,
      ...
      },
      {
        ...
        poster_path: '/yONcf5ZI2VMe8EcpV7YqJDGsS6z.jpg',
        media_type: 'movie',
        genre_ids: [80, 53],
        popularity: 43.036,
      ...
      },
      {
        ...
        poster_path: '/awlLBINV2ptoHkzeG20mIanlWqh.jpg',
        media_type: 'movie',
        genre_ids: [18],
        popularity: 30.385,
...
export default function MovieDetailPage() {
  ...
  // const release_dates_br = release_dates.results.filter(
  //   (release) => release.iso_3166_1 === 'BR'
  // )[0];
